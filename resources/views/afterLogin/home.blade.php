    ...
    @section('content')
            ...
            <div class="explore-content">
                ...
                <div class="explore-addition">
                    <div class="lihat-lanjut">
                        <a href="{{ route('atraction') }}" class="medium-text-font "><p>Lihat Lebih Lanjut →</p></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-padding-left-right" id="festival">
            <div class="explore-content">
                ...
                <div class="explore-addition">
                    <div class="lihat-lanjut">
                        <a href="{{ route('festival') }}" class="medium-text-font "><p>Lihat Lebih Lanjut →</p></a>
                    </div>
                </div>
            </div>
        </section>
    ...
    @section('scripts')
        <script>
            $(document).ready(function () {
                ...
                clickCardContent(".festival-trend-advertisment", "/detailAtraction");
