    ...
    @section('content')
        ...
        <section class="advertisment-section page-padding-left-right as-click">
            ...
            <img  class="festival-trend-advertisment" src="{{ secure_asset('asset/festival-promo.png') }}" alt="Festival terdekat">
        </section>
        ...
        <section class="points-section page-padding-left-right">
           <img class="ws-click" src="{{ secure_asset('asset/kuishome.png') }}" alt="Wawasan Nusantara">
        </section>
